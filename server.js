  ...
  app.put('/api/class-student-weekday', authenticateToken, authorizeRoles('admin'), async (req, res) => {
    try {
  ...
  app.delete('/api/class-student-weekday', authenticateToken, authorizeRoles('admin'), async (req, res) => {
    try {
